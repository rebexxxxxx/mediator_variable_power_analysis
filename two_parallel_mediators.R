...
if (input_method == "corr") {
  ...
  input_data <- data.frame(c21=runif(numIterations,min= cor21_low,max = cor21_high),
                           c31=runif(numIterations,min= cor31_low,max = cor31_high),
                           c32=runif(numIterations,min= cor32_low,max = cor32_high),
                           c41=runif(numIterations,min= cor41_low,max = cor41_high),
                           c42=runif(numIterations,min=cor42_low,max=cor42_high),
                           r43=runif(numIterations,min=cor43_low,max=cor43_high))

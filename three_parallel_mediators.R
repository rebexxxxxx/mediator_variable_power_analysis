...
calc_3mediator_power <- function(powReps = 10, mcmcReps = 10, seed = 2, 
  ...
  cor32 <- as.numeric(stdcoef[8])
  cor42 <- as.numeric(stdcoef[9])
  cor43 <- as.numeric(stdcoef[10])
...
if (input_method == "Correlations") {
  ...
  input_data <- data.frame(a1=runif(numIterations,min= a1_low,max = a1_high),
                           ...
                           a3=runif(numIterations,min= a3_low,max = a3_high),
                           ...
                           rm1m3=rep(cor42,numIterations),
                           rm2m3=rep(cor43,numIterations))
}
